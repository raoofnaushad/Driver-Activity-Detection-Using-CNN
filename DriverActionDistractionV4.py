...
def test_driver():
    ...
    while True:
        try:
            ...
            cv2.imwrite(filename='testing1/test/testing.jpg', img=frame)
            webcam.release()
            cv2.waitKey(1650)
            cv2.destroyAllWindows()
            print("Processing image...")
            img_ = cv2.imread('test1/test/testing.jpg', cv2.IMREAD_ANYCOLOR)
            print("Image saved!")
    ...
    test_files, test_targets = load_dataset('testing1')
    ...
    if category == 1:
        ...
        alert = "talking on the phone - right"
    elif category == 4:
        print("texting - left")
        alert = "texting - left"
    elif category == 5:
        print("talking on the phone - left")
        alert = "talking on the phone - left"
    elif category == 6:
        print("operating the radio")
        alert = "operating the radio"
    elif category == 7:
        print("Drinking")
        alert = "Drinking"
    elif category == 8:
        print("Reaching behind")
        alert = "Reaching behind"
    elif category == 9:
        print("hair and makeup")
        alert = "hair and makeup"
    elif category == 10:
        print("talking to passenger")
        alert = "talking to passenger"
    print("_--------------------__________________----------------------___________________-")
    
    # timer = threading.Timer(10.0, test_driver) 
    # timer.start()
